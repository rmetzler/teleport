...
var (
	...
	// SessionControlLimit is emitted when a user hits `max_concurrent_sessions`.
...
const (
	...
	// authenticated session has been rejected due to exceeding `max_concurrent_sessions`.
